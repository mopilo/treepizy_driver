...
import '../../../../vehicle_management/screen/provider/vehicle_provider.dart';
import '../../../../vehicle_management/screen/vehicle_verification_folder/vehicle_verification_pending.dart';
...
class _AddVehicleScreenState extends State<AddVehicleScreen> {
  ...
  List<String> select =['ytyuu','guyiui','gyuguy','erewr'];
  String selected = '';
              ...
              children: [
                ...
                vehicleInfoContainer(
                    ...
                    SizedBox(
                      ...
                      value: selected,
                      items: select.map((item)=> DropdownMenuItem<String>(
                      value:item,
                    child: Column(
                    children:[
                    Text(item, style:TextStyle(fontSize:14.sp,color:AppColors.grey)),
                    SizedBox(height:6.h),
                    Text(item, style:TextStyle(fontSize:17.sp,color:AppColors.black),)]))).toList(),
